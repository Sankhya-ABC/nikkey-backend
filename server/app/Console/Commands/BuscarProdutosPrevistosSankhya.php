...
class BuscarProdutosPrevistosSankhya extends Command
{
    protected $signature = 'sankhya:buscar-produtos-previstos';
    protected $description = 'Busca produtos previstos no Sankhya e atualiza a base local apenas se todas as FKs existirem.';

    public function handle(): int
    {
        $this->info('🚀 Iniciando sincronização de produtos previstos...');
